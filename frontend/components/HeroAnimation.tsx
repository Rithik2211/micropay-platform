      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-2">
            ...
            <div className="font-medium">MicroPay Platform</div>
          </div>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="text-2xl font-bold">$2,458.32</div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
              ...
              <div className="text-lg font-bold">+$854.20</div>
            </div>
          </div>
          ...
          <div className="pt-2">
            ...
            >
              <div className="text-xs">Subscription - Basic</div>
            ...
            >
              <div className="text-xs">Pay-per-view Article</div>
              <div className="text-xs font-medium">+$0.25</div>
            </motion.div>
            <motion.div 
            ...
            >
              <div className="text-xs">Premium Content</div>
              <div className="text-xs font-medium">+$1.50</div>
            </motion.div>
          </div>
        </div>
      </motion.div>
